      ...
      <div className="flex gap-6">
        <div className="w-48 flex-shrink-0">
          ...
          <div className="mt-4 space-y-1 border-t border-gray-200 pt-4">
            <Link
              href={`/tenant/${orgId}/settings/branding`}
            ...
            <Link
              href={`/tenant/${orgId}/settings/restrictions`}
              className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs text-gray-500 hover:bg-gray-100"
            >
              <span aria-hidden="true">🔒</span> What you can do
            </Link>
          </div>
        </div>
        ...
        <div className="flex-1">
          <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={inputClass}
                    placeholder="portal.mycampaign.com"
                  />
                </div>
              </div>
            )}
                  ...
                  {[
                    {
                      ...
                      checked: notifyOnBuildComplete,
                      onChange: setNotifyOnBuildComplete,
                    },
                    {
                      id: 'buildFailed',
                      label: 'Build failed',
                      checked: notifyOnBuildFailed,
                      onChange: setNotifyOnBuildFailed,
                    },
                    {
                      id: 'teamChanges',
                      label: 'Team member changes',
                      checked: notifyOnTeamChanges,
                      onChange: setNotifyOnTeamChanges,
                    },
                  ].map((n) => (
                    <div
                      key={n.id}
            ...
            {msg && (
              <div
                className={`mt-4 text-sm px-3 py-2 rounded ${msg.includes('Failed') ? 'text-red-700 bg-red-50' : 'text-green-700 bg-green-50'}`}
              >
                {msg}
              </div>
            )}
