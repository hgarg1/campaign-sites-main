    ...
    return (
      <TenantLayout title="Access Forbidden" orgId={orgId}>
        <div className="bg-red-50 border border-red-200 rounded-xl p-8 text-center">
          ...
          <Link href={`/tenant/${orgId}/hierarchy`} className="text-brand hover:text-brand-700 text-sm font-medium">← Back to Hierarchy</Link>
        </div>
      </TenantLayout>
    );
  }
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          {!policyEdit && (
            <button type="button"
              ...
              className="text-sm text-brand hover:text-brand-700 font-medium"
            >
        ...
        {policyLoading ? (
          ...
          <div className="space-y-4">
            ...
            {editRules.map((rule, i) => (
              <div key={i} className="flex items-center gap-2 flex-wrap bg-gray-50 border border-gray-200 rounded-lg p-3">
                <select
                  ...
                  className="border border-gray-300 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-brand"
                >
            ...
            <button type="button"
              onClick={addRule}
              className="text-sm text-brand hover:text-brand-700 font-medium border border-dashed border-brand-300 rounded-lg px-4 py-2 w-full"
            >
              + Add Rule
            </button>
